...
- Let's add and commit both the source `.Rmd` file, as well as the knitted `.md` file; remember to use your _first_ and _last_ names:
```
...
`warmup01`, you whould be able to see the `.Rmd` and `.md` files.
...
+ Open `up02-first-last.Rmd` and change the __output__ field as: 
`github_document`
...
```
- Go to your github repo, and check the contents of the folder 
`warmup02`, you whould be able to see the `.Rmd` and `.md` files.
- Take a look at the `.md` file, it should be rendered nicely by 
github.
