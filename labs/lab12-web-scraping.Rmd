...
curoius about extracting all the content in a character vector, then use 
...
simpler. For example, extracting the value of all the HTML elements __h2__ 
...
you need to use _X paths_. Xpaths are expressions (similar to file paths) that
allow you to indicate the specific _path_ that must be taken to arrive at a given node.
