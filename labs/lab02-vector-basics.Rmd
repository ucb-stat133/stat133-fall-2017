...
simply type them sirectly on the console:
...
either all numbers, all characters, or all logical values. To test is an object
...
Logical subsetting occurs when the vector of indices that pass inside the 
