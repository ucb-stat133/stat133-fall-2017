...
knitr::include_graphics('../images/gsw-2017-totals.png')
```

```{r out.width='60%', echo = FALSE, fig.align='center'}
knitr::include_graphics('../images/gsw-2017-salaries.png')
```
...
For instance, you can create a variable `thompson` and give it the value of Field Goals made by thompson (644).
